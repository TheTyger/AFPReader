...
namespace AFP_Reader.Structured_Field_Definitions
{
    class PagePosition2
    {
        public const string Code = "PGP-2";
        public const string Name = "Page Position (Format 2)";
        ...
        public const string Reference = "AFP Mixed Object Document Content.pdf - 340pg ";
